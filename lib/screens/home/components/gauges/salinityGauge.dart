...
class salinityGauge extends StatelessWidget {
  ...
  salinityGauge({required this.parameter_value, required this.optimumMin, required this.optimumMax});
      ...
      axes: <RadialAxis>[
        RadialAxis(
          annotations: <GaugeAnnotation>[
              GaugeAnnotation(axisValue: 25, positionFactor: 0.4,
              widget: Text("$parameter_value ppt", style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.bold),))],
          axisLineStyle: const AxisLineStyle(
            thickness: 0.15,
            thicknessUnit: GaugeSizeUnit.factor,
            ),
          minimum: 0,
          maximum: 50, // parameter_value scale from 0 to 14
