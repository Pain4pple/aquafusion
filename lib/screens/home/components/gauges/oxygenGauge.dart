...
class oxygenGauge extends StatelessWidget {
  ...
  oxygenGauge({required this.parameter_value, required this.optimumMin, required this.optimumMax});
      ...
      axes: <RadialAxis>[
        RadialAxis(
          annotations: <GaugeAnnotation>[
              GaugeAnnotation(axisValue: 7.5, positionFactor: 0.4,
              widget: Text("$parameter_value ppm", style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.bold),)
              )
              ],
          ...
          minimum: 0,
          maximum: 15, // parameter_value scale from 0 to 14
