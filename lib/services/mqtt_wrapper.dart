...
class MQTTClientWrapper {
  ...
  void prepareMqttClient() async {
    ...
    _subscribeToTopic('aquafusion/test');
    _publishMessage('Hello this is Lara');
  }
  ...
  void _publishMessage(String message) {
    ...
    print('Publishing message "$message" to topic ${'aquafusion/test'}');
    client.publishMessage('aquafusion/test', MqttQos.exactlyOnce, builder.payload!);
  }
